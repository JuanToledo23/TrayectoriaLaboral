...
function agregarEvento(grupo) {
    ...
    //     for (let index = 0; index < grupo.length; index++) {
    //         var fechaInicioNumerica = fechaNumerica(grupo[index].fechaInicio);
    //         if (fechaInicioNumerica < menorFechaGrupal)
    //         {
    //             menorFechaGrupal = fechaInicioNumerica;
    //             eventoAyorDuracion = grupo[index];
    //         }
    //     }

    // } else {
    //     menorFechaGrupal = grupo[0].duracion;
    //     eventoAyorDuracion = grupo[0];
    // }
